...
//await client.WriteSingleRegister(SunspecConsts.Storage_Control_Mode, (ushort)StorageControlMode.RemoteControl);
//await client.WriteSingleRegister(SunspecConsts.Remote_Control_Command_Timeout, (uint)60);
//await client.WriteSingleRegister(SunspecConsts.Remote_Control_Command_Mode, (ushort)RemoteControlMode.ChargeFromPVPlusACAccordingToTheMaxBatteryPower);
////await client.WriteSingleRegister(SunspecConsts.Storage_Charge_Discharge_Default_Mode, (ushort)RemoteControlMode.MaximizeSelfConsumption);
//await client.WriteSingleRegister(SunspecConsts.Remote_Control_Charge_Limit, (float)1500);
...
//var resultE = await client.ReadHoldingRegisters<UInt16>(SunspecConsts.Remote_Control_Command_Mode);
//Console.WriteLine($"Remote_Control_Command_Mode: {resultE}");

//var resultF = await client.ReadHoldingRegisters<UInt16>(SunspecConsts.Storage_Charge_Discharge_Default_Mode);
//Console.WriteLine($"Storage_Charge_Discharge_Default_Mode: {resultF}");
